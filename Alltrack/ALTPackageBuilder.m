...
//  Copyright (c) 2013-2018 Alltrack GmbH. All rights reserved.
//
...
- (ALTActivityPackage *)buildSessionPackage:(BOOL)isInDelay {
    ...
    sessionPackage.parameters = [ALTUtil deepCopyOfDictionary:sessionPackage.parameters];
...
- (ALTActivityPackage *)buildEventPackage:(ALTEvent *)event
    ...
    if (isInDelay) {
        eventPackage.callbackParameters = [ALTUtil deepCopyOfDictionary:event.callbackParameters];
        eventPackage.partnerParameters = [ALTUtil deepCopyOfDictionary:event.partnerParameters];
    }

    [self signWithSigV2Plugin:eventPackage];
    eventPackage.parameters = [ALTUtil deepCopyOfDictionary:eventPackage.parameters];
...
- (ALTActivityPackage *)buildInfoPackage:(NSString *)infoSource {
    ...
    infoPackage.parameters = [ALTUtil deepCopyOfDictionary:infoPackage.parameters];
...
- (ALTActivityPackage *)buildAdRevenuePackage:(NSString *)source payload:(NSData *)payload {
    ...
    adRevenuePackage.parameters = [ALTUtil deepCopyOfDictionary:adRevenuePackage.parameters];
...
- (ALTActivityPackage *)buildAdRevenuePackage:(ALTAdRevenue *)adRevenue isInDelay:(BOOL)isInDelay {
    ...
    if (isInDelay) {
        adRevenuePackage.callbackParameters = [ALTUtil deepCopyOfDictionary:adRevenue.callbackParameters];
        adRevenuePackage.partnerParameters = [ALTUtil deepCopyOfDictionary:adRevenue.partnerParameters];
    }
...
- (ALTActivityPackage *)buildClickPackage:(NSString *)clickSource extraParameters:(NSDictionary *)extraParameters {
    ...
    clickPackage.parameters = [ALTUtil deepCopyOfDictionary:clickPackage.parameters];
...
- (ALTActivityPackage *)buildAttributionPackage:(NSString *)initiatedBy {
    ...
    attributionPackage.parameters = [ALTUtil deepCopyOfDictionary:attributionPackage.parameters];
...
- (ALTActivityPackage *)buildGdprPackage {
    ...
    gdprPackage.parameters = [ALTUtil deepCopyOfDictionary:gdprPackage.parameters];
...
- (ALTActivityPackage *)buildDisableThirdPartySharingPackage {
    ...
    dtpsPackage.parameters = [ALTUtil deepCopyOfDictionary:dtpsPackage.parameters];
...
- (ALTActivityPackage *)buildThirdPartySharingPackage:(nonnull ALTThirdPartySharing *)thirdPartySharing {
    ...
    tpsPackage.parameters = [ALTUtil deepCopyOfDictionary:tpsPackage.parameters];
...
- (ALTActivityPackage *)buildMeasurementConsentPackage:(BOOL)enabled {
    ...
    mcPackage.parameters = [ALTUtil deepCopyOfDictionary:mcPackage.parameters];
...
- (ALTActivityPackage *)buildSubscriptionPackage:(ALTSubscription *)subscription
    ...
    if (isInDelay) {
        subscriptionPackage.callbackParameters = [ALTUtil deepCopyOfDictionary:subscription.callbackParameters];
        subscriptionPackage.partnerParameters = [ALTUtil deepCopyOfDictionary:subscription.partnerParameters];
    }

    [self signWithSigV2Plugin:subscriptionPackage];
    subscriptionPackage.parameters = [ALTUtil deepCopyOfDictionary:subscriptionPackage.parameters];
