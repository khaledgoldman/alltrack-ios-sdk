...
if [ -z ${XCF_OUTPUT_FOLDER+x} ]; then 
  	...
  	function usage(){
  		...
  		echo -e "${RED}[ALLTRACK][BUILD]:${GREEN}
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Usage: $0 [options]
...
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -${NC}"
	...
	SCHEMA_NAME__ALLTRACK_IOS="AlltrackSdk"
	SCHEMA_NAME__ALLTRACK_TV="AlltrackSdkTv"
	SCHEMA_NAME__ALLTRACK_IM="AlltrackSdkIm"
	SCHEMA_NAME__ALLTRACK_WEB_BRIDGE="AlltrackSdkWebBridge"

	# SDK Schema names - Static
	SCHEMA_NAME__ALLTRACK_IOS_STATIC="AlltrackSdkStatic"
	SCHEMA_NAME__ALLTRACK_TV_STATIC="AlltrackSdkTvStatic"
	SCHEMA_NAME__ALLTRACK_IM_STATIC="AlltrackSdkImStatic"
	SCHEMA_NAME__ALLTRACK_WEB_BRIDGE_STATIC="AlltrackSdkWebBridgeStatic"

	# SDK frameworks and xcframework names
	XCF_FRM_NAME__ALLTRACK_IOS="AlltrackSdk"
	XCF_FRM_NAME__ALLTRACK_TV="AlltrackSdkTv"
	XCF_FRM_NAME__ALLTRACK_IM="AlltrackSdkIm"
	XCF_FRM_NAME__ALLTRACK_WEB_BRIDGE="AlltrackSdkWebBridge"

	# xcode archive names
	ARCHIVE_NAME__IOS_DEVICE="AlltrackSdk-Device"
	ARCHIVE_NAME__IOS_SIMULATOR="AlltrackSdk-Simulator"
	ARCHIVE_NAME__TV_DEVICE="AlltrackSdkTv-Device"
	ARCHIVE_NAME__TV_SIMULATOR="AlltrackSdkTv-Simulator"
	ARCHIVE_NAME__IM_DEVICE="AlltrackSdkIm-Device"
	ARCHIVE_NAME__IM_SIMULATOR="AlltrackSdkIm-Simulator"
	ARCHIVE_NAME__WEB_DEVICE="AlltrackSdkWebBridge-Device"
	ARCHIVE_NAME__WEB_SIMULATOR="AlltrackSdkWebBridge-Simulator"

	# XCFrameworks and Frameworks archive (ZIP) names
	XCF_FRM_ZIP_NAME__IOS_TV_DYNAMIC="AlltrackSdk-iOS-tvOS-Dynamic"
	XCF_FRM_ZIP_NAME__IOS_TV_STATIC="AlltrackSdk-iOS-tvOS-Static"
	XCF_FRM_ZIP_NAME__IOS_DYNAMIC="AlltrackSdk-iOS-Dynamic"
	XCF_FRM_ZIP_NAME__IOS_STATIC="AlltrackSdk-iOS-Static"
	XCF_FRM_ZIP_NAME__TV_DYNAMIC="AlltrackSdk-tvOS-Dynamic"
	XCF_FRM_ZIP_NAME__TV_STATIC="AlltrackSdk-tvOS-Static"
	XCF_FRM_ZIP_NAME__IM_DYNAMIC="AlltrackSdk-iMessage-Dynamic"
	XCF_FRM_ZIP_NAME__IM_STATIC="AlltrackSdk-iMessage-Static"
	XCF_FRM_ZIP_NAME__WEB_BRIDGE_DYNAMIC="AlltrackSdk-WebBridge-Dynamic"
	XCF_FRM_ZIP_NAME__WEB_BRIDGE_STATIC="AlltrackSdk-WebBridge-Static"
  ...
  echo -e "${CYAN}[ALLTRACK][BUILD]:${YELLOW} The definitions script has been already executed. Skipping it... ${NC}"
