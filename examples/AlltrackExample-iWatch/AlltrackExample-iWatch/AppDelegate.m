...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    [[AlltrackTrackingHelper sharedInstance] initialize:self];
    [[AlltrackLoggingHelper sharedInstance] logText:@"Method ""didFinishLaunchingWithOptions"" finished!"];
...
- (void)alltrackAttributionChanged:(ALTAttribution *)attribution {
    NSLog(@"alltrack attribution %@", attribution);
}
...
- (void)session:(WCSession *)session didReceiveMessage:(NSDictionary<NSString *,id> *)message replyHandler:(void (^)(NSDictionary<NSString *,id> * _Nonnull))replyHandler {
    if ([[message objectForKey:@"request"] isEqualToString:@"event_simple"]) {
        ...
        [[AlltrackLoggingHelper sharedInstance] logText:@"Simple event tracked!"];
        ...
        [[AlltrackLoggingHelper sharedInstance] logText:@"Revenue event tracked!"];
        ...
        [[AlltrackLoggingHelper sharedInstance] logText:@"Callback event tracked!"];
        ...
        [[AlltrackLoggingHelper sharedInstance] logText:@"Partner event tracked!"];
    }
}
