...
- (void)injectJavascriptFile {
    ...
    // Added to inject alltrack js code
    //NSString *alltrack_js = AlltrackBridge_js();
    NSString *alltrack_js = [AlltrackBridgeRegister AlltrackBridge_js];
    [self _evaluateJavascript:alltrack_js];
